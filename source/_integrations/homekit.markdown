        ...
        '`ENTITY_ID`':
          ...
          keys:
            ...
            linked_doorbell_sensor:
              description: The `entity_id` of a `binary_sensor` or `event` entity to use as the doorbell sensor of a lock or of the camera accessory to enable doorbell notifications.
              required: false
              type: string
...
| lock                                                          | DoorLock               | Support for `lock / unlock`. A doorbell event / sensor could be linked with `linked_doorbell_sensor`.                                                                                                                                                                                                                                                                                                                                                                                                             |
